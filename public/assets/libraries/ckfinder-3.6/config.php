...
$config['licenseName'] = 'www.agriehomeclinic.vn';
$config['licenseKey']  = 'XMTM5HMHK9AWNLTW5RL5GWSFU3WMV';
//$config['licenseName'] = 'agrie.local';
//$config['licenseKey']  = 'LX2XJBTK2U3QC3JXWJP9QM77Q22EH';
